// Généré par parse_arcanes.py — ne pas éditer à la main
window.ARCANES_DATA = {
  "_meta": {
  ...
  "intro_etape_2": "La Main du Destin est le seul élément aléatoire de la création de votre Héros, mais l’un des plus structurants pour son rôle dans l’aventure.\n\nLes Sorte Streghe, sorcières de la Destinée, lisent l’aura des Héros à travers 20 Arcanes (en plus de l’Arcane 0 et de l’Arcane 21, soit 22 cartes au total). Chaque carte révèle une Vertu (élément qui fait du PJ un Héros) et un Travers (sa plus grande faiblesse émotionnelle).\n\nLe MJ tire au hasard et donne une carte par joueur, qui gagne la Vertu et le Travers associés. Si le tirage convient mal au concept, le PJ peut tirer une seconde carte et choisir le couple Vertu / Travers parmi les deux.\n\nActivation de la Vertu : une fois par partie, sans coût, dans une circonstance appropriée (rencontre, autre Héros blessé, etc.). Permet d’obtenir un avantage ponctuel.\n\nActivation du Travers : une fois par partie, à votre initiative ou proposée par le MJ. Rapporte un point d’Héroïsme. Le joueur peut toujours refuser une proposition du MJ — mais accepter, c’est créer du jeu et révéler la profondeur de son PJ.",
  "arcanes": [
    {
      "numero": 0,
      "nom": "Le bateleur",
      "travers": "Curieux",
      "vertu": "Béni des dieux"
    },
    {
      "numero": 1,
      "nom": "Le magicien",
    ...
    },
    {
      "numero": 6,
      "nom": "Les amoureux",
      "travers": "Amour impossible",
      "vertu": "Passionné"
    },
    {
      "numero": 7,
      "nom": "Le chariot",
      "travers": "Présomptueux",
      "vertu": "Victorieux"
    },
    {
      "numero": 8,
