  ...
  "ecoles": [
    ...
    },
    {
      ...
      "specialisations": [
        "Couteau",
        "Escrime. De plus",
        "le spadassin doit au moins  être un sorcier Porté demi-sang"
      ],
      "description_courte": "La famille Praisse de Rachecourt a dans ses rangs certains des sorciers Porté les plus puissants de toute la Montaigne. Malgré tout, jusqu’à il y a peu de temps, ils hésitaient à utiliser leurs pouvoi",
      "techniques_combat": [
        {
          "nom_base": "Exploiter les faiblesses",
          "variante": "Escrime",
      ...
      "details": {
        "origine_texte": "Montaigne.",
        "academies": "Uniquement au sein de la famille Rachecourt.",
        "description_longue": [
          "La famille Praisse de Rachecourt a dans ses rangs certains des sorciers Porté les plus puissants de toute la Montaigne. Malgré tout, jusqu’à il y a peu de temps, ils hésitaient à utiliser leurs pouvoirs en raison des interdictions de l’Église et durent trouver d’autres moyens pour se défendre. Un Rachecourt en particulier, Aymeric, était un grand spadassin de l’École Valroux. Quand Léon monta sur le trône et déclara la sorcellerie Porté comme légale et publique, Aymeric, alors en ambassade près des cardinaux de Numa, déclara qu’il était sorcier.",
          ...
          "Après cet événement, Aymeric enseigna sa technique à quelques membres de sa famille, y compris quelques demi-sang avant qu’un assassin ne le tue pendant son sommeil (bien entendu, l’Inquisition revendiqua cet assassinat comme un acte de justice).",
          "La faiblesse de cette École réside dans la mise en place des trous Porté. Pendant ce temps, le spadassin Rachecourt doit surtout esquiver les attaques de ses ennemis tout en les provoquant verbalement afin de les déconcentrer, ce qui est loin d’être une position confortable !",
          "Sauf indications contraires, les trous Porté durent jusqu’à la fin du round où ils ont été ouverts."
        ],
        ...
        "niveaux": {
          "apprenti": {
            "fluff": "Il apprend à combattre avec une rapière dans sa main droite et une dague dans l’autre. Avec ce couteau, il ouvre des fissures dans la structure de l’univers en utilisant ses capacités Porté.",
            "regles": "Ainsi, il peut se défendre en emprisonnant les lames de ses ennemis dans ces failles. Ces ouvertures se referment rapidement, emprisonnant ces armes définitivement. De plus, il ne subit pas la pénalité de main non directrice pour l’utilisation de son couteau dans sa main gauche. Enfin, il peut utiliser sa technique de combat Poche à la place de sa compétence de Parade (Couteau). Cela lui permet de l’utiliser comme une défense active, bloquant alors les armes de ses adversaires."
          },
          "compagnon": {
            "fluff": "Le spadassin apprend à utiliser ses fissures Porté pour se défendre efficacement contre les attaques adverses.",
            "regles": "La technique de combat Poche (Porté) peut être utilisée comme défense active et passive contre les attaques de mêlée et de distance avec une augmentation gratuite. Ensuite, le compagnon Rachecourt a toujours une arme à sa disposition. Il apprend à créer un “fourreau Porté” dans lequel il glisse une rapière et un couteau de rechange. Ainsi, s’il est désarmé pendant le combat, il peut récupérer rapidement une arme. Pour cela, il dépense une action et s’empare de l’arme qu’il avait “dissimulée”."
          },
          "maitre": {
            "fluff": "Le maître Rachecourt maîtrise maintenant parfaitement ses portails. Il peut attaquer avec sa rapière en passant par n’importe quelle fissure Porté et en ressortant par une autre.",
            "regles": "En raison de la nature inattendue de ce type d’attaque, l’adversaire ne peut absolument pas utiliser de défense active. Toutefois, pour réussir une telle attaque et en raison des angles d’attaque difficiles à appréhender, le spadassin Rachecourt subit deux augmentations de malus sur son attaque. Mais l’inconvénient, c’est qu’une fois que ce passage est ouvert, l’adversaire peut également l’utiliser pour vous attaquer, car il reste ouvert toute la scène !"
          }
        }
      },
      "enrichie": true,
